...
public class UserManageBook {
   ...
   switch(ch) {
            ...
            case 2:
                ...
                System.out.println("please double check if you want to delete all books, yes enter 1, if not enter 2!\n");
                                ...
                                break;
                                    ...
                                    System.out.println("Wrong enter, please try again!");
                                                    break;
                                                            ...
                                                            System.out.println("please enter the numer to search, 1: search by id, 2: search by name, 3: search by author, 4: search by category\n");
                                                            
                                                            Scanner search = new Scanner(System.in);
                                                               
                                                               
                                                            double s=search.nextDouble();
                                                            if(s == 1) {System.out.println("please input book's id");
                                                                Scanner ssid = new Scanner(System.in); 
                                                                String nsid=ssid.nextLine();
                                                             manage.searchById(nsid);
                                                             break;
                                                            }if (s == 2) {System.out.println("please input book's name");
                                                                Scanner ssname = new Scanner(System.in);
                                                                String nsname =ssname.nextLine();
                                                 manage.searchByName(nsname);
                                                 break;
                                                 }if (s == 3){ System.out.println("please input author's name");
                                                    Scanner ssatu = new Scanner(System.in);
                                                    String nsatu=ssatu.nextLine();
                                                  manage.searchByAuthor(nsatu);
                                                  break;
                                                 }if (s == 4){System.out.println("please input book's category");
